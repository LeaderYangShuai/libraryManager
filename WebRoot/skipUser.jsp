...
<body>
	<%
		...
		if (path == null) {
			...
			request.getRequestDispatcher("/WEB-INF/course/course4/course4-user/addUser.jsp").forward(request, response);
		}else if ("userSelect".equals(path)) {
			request.getRequestDispatcher("/WEB-INF/course/course4/course4-user/selectUser.jsp").forward(request, response);
		}else if ("userUpdate".equals(path)) {
			request.getRequestDispatcher("/WEB-INF/course/course4/course4-user/updateUser.jsp").forward(request, response);
